...
class PresenceStanza extends AbstractStanza {
  ...
  String? get status {
    var statusElement = children.firstWhereOrNull((element) => element.name == 'status' && element.attributes.isEmpty);
    return statusElement?.textValue;
  }

  set status(String? value) {
    var childElement = children.firstWhereOrNull((element) => element.name == 'status' && element.attributes.isEmpty);
  ...
  int? get priority {
    if (getChild('priority')?.textValue == null) {
      return null;
    }
